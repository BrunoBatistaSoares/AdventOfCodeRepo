export function D7P2(input: string) {
    let result = 0;
    ...
    handsBetsValues.forEach((handBetValue, index) => {
        ...
        console.log(cardSnatcher);
        console.log(jokers);




        if (cardSnatcher[0] + jokers === 5) {
            handsBetsValues[index].value = 7
        }
        else if (cardSnatcher[0] + jokers === 4) {
            handsBetsValues[index].value = 6
        }
        else if (cardSnatcher[0] + jokers === 3) {
            if (cardSnatcher[1] === 2) {
        ...
        else if (cardSnatcher[0] + jokers === 2) {
            if (cardSnatcher[1] === 2) {
